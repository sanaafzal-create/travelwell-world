...
| sub_region 05A | `Kenya — North Coast / Malindi & Watamu` | U+2014 `—` |
| sub_region 05A | `Kenya — Lamu Archipelago` | U+2014 `—` |
| sub_region 05A | `Kenya — Rift Valley Lakes` | U+2014 `—` |
| sub_region 05A | `Kenya — Mount Kenya & the Central Highlands` | U+2014 `—` |
| sub_region 05A | `Kenya — Nairobi` | U+2014 `—` |
| sub_region 05A | `Tanzania — Mainland Coast & Kilwa` | U+2014 `—` |
| sub_region 05A | `Tanzania — Arusha & the Northern Gateway` | U+2014 `—` |
| sub_region 05A | `Tanzania — Southern Circuit / Mikumi` | U+2014 `—` |
